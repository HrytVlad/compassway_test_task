...
def parse_weather():
    ...
    for day in weather_days:
        ...
        date = datetime.strptime(converted_date_str, '%d.%m.%Y').date()  # Конвертація в тип date
        ...
        try:
            ...
            weather = Weather.objects.create(date=date, temperature=temperature_max, weather_description=description)
            weather.save()
